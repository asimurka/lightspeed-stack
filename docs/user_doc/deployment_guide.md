...
* [Local deployment](#local-deployment)
    * [OGX used as a separate process](#OGX-used-as-a-separate-process)
        ...
        * [Run OGX in a separate process](#run-llama-stack-in-a-separate-process)
...
* [Running from container](#running-from-container)
    ...
    * [OGX used as a separate process](#OGX-used-as-a-separate-process-1)
        ...
        * [Run OGX in a separate process](#run-llama-stack-in-a-separate-process-1)
...
1. Copy the project file named `pyproject.llamastack.toml` into the new directory, renaming it to `pyproject.toml':
    ```bash
    cp examples/pyproject.llamastack.toml /tmp/OGX-server/pyproject.toml
    ```
