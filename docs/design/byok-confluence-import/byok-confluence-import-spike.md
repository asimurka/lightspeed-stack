...
<!-- type: Task -->
<!-- key: LCORE-3381 -->
### LCORE-3381: rag-content: generated OGX.yaml conflicts with registration persisted in faiss_store.db

**Description**: A freshly built `llamastack-faiss` store cannot be opened
with its own generated `OGX.yaml`: the
...
- **Incidental bug**: generated `OGX.yaml` + `query_rag.py`
