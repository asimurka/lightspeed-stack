...
def parse_model_list_response(
    ...
    ``client.models.list()`` returns ``ListModelsV1ModelsGet200Response``.
    This helper unwraps ``actual_instance`` and matches on the concrete
    ``OpenAIListModelsResponse``, ``AnthropicListModelsResponse``, or
    ``GoogleListModelsResponse`` body.
