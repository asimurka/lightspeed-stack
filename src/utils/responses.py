...
def parse_referenced_documents(  # pylint: disable=too-many-locals,too-many-branches,too-many-nested-blocks
    response: Optional[OpenAIResponseObject],  # pylint: disable=unused-argument
