...
def llm_inference_span_attributes(
    ...
    Includes tool calls, RAG chunks, tool results, model/provider ids, token
    usage, and inference duration. Serializes nested structures as JSON for
    OTEL primitives.
...
def root_span_turn_attributes(
    ...
    *,
    ...
    Input is typically set earlier on the root span when the request is
    received; this helper covers fields available after the turn completes.
