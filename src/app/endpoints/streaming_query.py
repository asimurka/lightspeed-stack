...
async def streaming_query_endpoint_handler(  # pylint: disable=too-many-locals
    ...
    Returns:
        ...
        SSE-formatted events for the query lifecycle. Content type depends on
        the request's media_type parameter, defaulting to text/plain for
        successful responses, or text/event-stream for certain error responses.
    ...
    Raises:
        HTTPException:
            ...
            - 429: Quota limit exceeded - The token quota for model or userhas been exceeded
...
async def generate_response(
    ...
    Re-yields all events from the generator, handles errors during re-yielding,
    and ensures persistence and token consumption happen after the generator completes.
    ...
    Yields:
        str: SSE-formatted strings from the wrapped generator
    """
...
async def response_generator(  # pylint: disable=too-many-branches,too-many-statements,too-many-locals
    ...
    language model turn. Populates turn_summary during streaming.
